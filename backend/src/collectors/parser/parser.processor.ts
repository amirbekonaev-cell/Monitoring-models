...
export const PARSER_COLLECT_QUEUE = 'parser-collect';

@Processor(PARSER_COLLECT_QUEUE)
export class ParserProcessor extends WorkerHost {
  ...
  async process(_job: Job): Promise<void> {
    const sources = await this.sourcesService.findActiveByType(SourceKind.PARSER);
